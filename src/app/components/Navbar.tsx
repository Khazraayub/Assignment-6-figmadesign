  ...
  return (
    <>
      <nav className="w-full h-[92px] bg-[#043873] text-white md:text-lg py-4 px-4 sm:px-6 flex justify-between items-center md:pl-20 mb-12 md:mb-2 relative">
        ...
        <div className={`${font} hidden md:flex items-center space-x-8`}>
          <ul className="flex space-x-6">
            <li>
              <Link href="#" className="hover:underline hover:text-[#FFE492]">
                Products
              </Link>
            </li>
            <li>
      ...
      <div
        ...
        } absolute ml-8 top-[92px] left-0 w-[260px] bg-[#043873] text-white py-4 transition-all duration-300 ease-in-out`}
      >
        <ul>
          <li className="py-2">
            <Link href="#" className="hover:underline hover:text-[#FFE492]">
